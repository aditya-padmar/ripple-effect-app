    ...
    <div className="flex-1 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md bg-white border border-slate-200 p-8 rounded-2xl shadow-xl backdrop-blur transition-colors duration-200 dark:bg-navy-900/90 dark:border-navy-700/70 dark:shadow-2xl">
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link
                href="/reset-password"
                className="text-[11px] text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 transition-colors font-medium"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <div className="mt-8 text-center text-xs text-slate-500 dark:text-slate-400">
          ...
          <Link href="/signup" className="text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 font-semibold transition-colors">
            Sign up
          </Link>
        </div>
      </div>
